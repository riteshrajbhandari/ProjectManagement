                ...
                <div class=" row justify-content-md-center p-5 m-5 border">
                    ...
                    ?>
                        <div class="col-md-auto text-center ">
                            <div class="card " style="width: 200px;height:50px; box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
