    ...
    <div class="container py-5 my-5 ">
        <div class="card">
            <div class="card-header ">
                ...
                $stid = oci_parse($connection, "SELECT ORDER_DATE FROM ORDERS WHERE FK1_PAYMENT_ID = (SELECT MAX(FK1_PAYMENT_ID) FROM ORDERS)");
                oci_execute($stid);
                ...
                <div class="table-responsive-sm">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $stid = oci_parse(
                                $connection,
                                "SELECT P.PRODUCT_NAME, P.SHORT_DESCRIPTION, P.UNIT_PRICE, OP.PRODUCT_QUANTITY, 
(P.UNIT_PRICE * OP.PRODUCT_QUANTITY) AS SUBTOTAL FROM ORDERS O, ORDER_PRODUCT OP, PRODUCT P
